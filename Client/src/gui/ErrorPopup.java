...
public class ErrorPopup {
	 ...
	 * <p> {@code 3} Not a valid check-in date (future date) //TODO REMOVE
	 * <p> {@code 4} Id doesnt exist (no match found/not valid format)
	 * <p> {@code 5} Wrong username or password.
	 * <p> {@code 6} No shifts to display//TODO REMOVE
	 * <p> {@code 7} No treatment to display
	 * <p> {@code 8} Shift date cannot be on the past//TODO REMOVE
	 * <p> {@code 9} No patients to display
	 * <p> {@code 10} No shifts for the selected date//TODO REMOVE
	 ...
	 * <p> {@code 15} XML - Shifts - cannot export to file//TODO REMOVE
	 * <p> {@code 16} XML - Shifts - cannot import from file//TODO REMOVE
	 * <p> {@code 17} New password == Old password
	 * <p> {@code 18} XML - cannot convert xml to html//TODO REMOVE
	 * <p> {@code 19} XML - Worker - cannot import from file//TODO REMOVE
	 * <p> {@code 20} XML - Worker - cannot export to file//TODO REMOVE
